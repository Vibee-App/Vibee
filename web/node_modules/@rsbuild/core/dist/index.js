    ...
    if (hasErrors) {
        ...
        return {
            message: function(errors) {
                let title = __WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js_ea7a20e9__.default.bold(__WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js_ea7a20e9__.default.red('Compile error: '));
                ...
                let tip = __WEBPACK_EXTERNAL_MODULE__compiled_picocolors_index_js_ea7a20e9__.default.yellow('Failed to compile, check the errors for troubleshooting.'), text = `${errors.join('\n\n')}\n`;
                return `${title}\n${tip}\n${text}`;
            }(errors),
            level: 'error'
        };
...
function parsePackageOrReadConfig(file) {
    return 'package.json' === __WEBPACK_EXTERNAL_MODULE_node_path_c5b9b54f__.default.basename(file) ? parsePackage(file) : function(file) {
    ...
    profileSession && profileSession.post('Profiler.stop', (error, param)=>{
        ...
        async setup (api) {
            ...
            let timestamp = Date.now(), profileDirName = `rspack-profile-${timestamp}`, enableProfileTrace = 'ALL' === RSPACK_PROFILE || RSPACK_PROFILE.includes('TRACE'), enableCPUProfile = 'ALL' === RSPACK_PROFILE || RSPACK_PROFILE.includes('CPU'), enableLogging = 'ALL' === RSPACK_PROFILE || RSPACK_PROFILE.includes('LOGGING'), onStart = ()=>{
                ...
                __WEBPACK_EXTERNAL_MODULE_node_fs_5ea92f0c__.default.existsSync(profileDir) || __WEBPACK_EXTERNAL_MODULE_node_fs_5ea92f0c__.default.mkdirSync(profileDir, {
                    recursive: !0
            ...
            api.onBeforeBuild(({ isFirstCompile })=>{
                ...
                if (enableLogging && stats) {
                    ...
                    __WEBPACK_EXTERNAL_MODULE_node_fs_5ea92f0c__.default.writeFileSync(loggingFilePath, JSON.stringify(logging));
                }
            }), api.onExit(()=>{
...
let compilerDevMiddleware_require = (0, __WEBPACK_EXTERNAL_MODULE_node_module_ab9f2194__.createRequire)(import.meta.url), formatDevConfig = (config, environments)=>{
...
<html>
  ...
  <body>
    ...
    let distPath = (0, __WEBPACK_EXTERNAL_MODULE_node_path_c5b9b54f__.isAbsolute)(output.distPath) ? output.distPath : (0, __WEBPACK_EXTERNAL_MODULE_node_path_c5b9b54f__.join)(pwd, output.distPath);
...
async function devServer_createDevServer(options, createCompiler, config, { compiler: customCompiler, getPortSilently, runCompile = !0 } = {}) {
    ...
    let outputFileSystem = __WEBPACK_EXTERNAL_MODULE_node_fs_5ea92f0c__.default, waitFirstCompileDone = runCompile ? new Promise((resolve)=>{
